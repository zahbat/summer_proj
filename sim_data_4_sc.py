...
def build_raw(pca=False, pca_details=False):
    
    """
    Builds a raw array containing the data from out.csv 
    without splitting or shuffling anything.
    """
